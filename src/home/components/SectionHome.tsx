  ...
  return (
    <div className="flex flex-col flex-wrap justify-center items-center mt-8 max-w-4xl w-[90%] mx-auto">
      <div className="flex flex-col-reverse lg:flex-row justify-center items-center w-full max-w-4xl">
        <div className="bg-gray-200 p-4 w-full lg:w-1/2 rounded-b-md lg:rounded-tl-md lg:rounded-br-none lg:rounded-bl-md">
        ...
        <Image
          ...
          width={200}
          height={448}
          className="object-cover max-h-96 w-full lg:max-w-[470px] rounded-t-md lg:rounded-tr-md lg:rounded-tl-none lg:rounded-br-md"
